...
export const metadata: Metadata = {
  title: 'Infrastructure Construction Tanzania — Roads, Bridges & Public Works | Tanzibaba',
  ...
  keywords: ['infrastructure construction Tanzania', 'road construction Tanzania', 'bridge construction Tanzania', 'drainage systems Tanzania', 'public works Tanzania'],
  alternates: { canonical: `${siteUrl}/infrastructure-construction-tanzania` },
  openGraph: {
    title: 'Infrastructure Construction Tanzania — Roads, Bridges & Public Works | Tanzibaba',
    ...
    url: `${siteUrl}/infrastructure-construction-tanzania`,
    siteName: 'Tanzibaba',
    type: 'website',
    locale: 'en_TZ',
...
export default function InfrastructureConstructionTanzaniaPage() {
  return (
    <>
      <Navbar />
      <main>
        <section className="relative min-h-[70vh] flex items-center bg-gray-950 overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/new/infrastructure-project.webp" alt="Infrastructure construction projects across Tanzania" fill className="object-cover" style={{ objectPosition: '50% 40%' }} priority fetchPriority="high" sizes="100vw" quality={85} />
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 bg-amber-600/20 border border-amber-500/30 text-amber-300 px-4 py-2 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
                <HardHat className="w-4 h-4" /> Infrastructure Construction Tanzania
              </div>
              ...
              <p className="text-lg sm:text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Delivering road networks, bridges, drainage systems and public utilities across Tanzania. Primary operations in Dar es Salaam, Zanzibar and Dodoma.
              </p>
