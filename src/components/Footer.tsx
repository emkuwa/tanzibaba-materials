    ...
    <footer className="bg-gray-950 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed max-w-xs">
              Premium construction materials supplier — ready mix concrete, aggregates, blocks and building materials across Tanzania.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          ...
          <p className="text-gray-600 text-center">Premium Building Materials Supplier Across Tanzania.</p>
        </div>
      </div>
    </footer>
  );
