    ...
    <>
      ...
      <main>
        ...
        <div className="relative h-56 md:h-72 rounded-2xl overflow-hidden mb-8">
          <Image src="/images/new/commercial-building.webp" alt="Ready-mix concrete for apartment buildings — essential guide for multi-storey construction in Dar es Salaam" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" loading="lazy" />
        </div>
