...
const products = [
  ...
  { icon: Square, title: 'Premium Concrete Blocks', desc: 'Hollow and solid blocks in standard sizes for walls and load-bearing construction.', href: '/blocks-supplier-dar-es-salaam', image: '/images/new/hollow-blocks.webp' },
