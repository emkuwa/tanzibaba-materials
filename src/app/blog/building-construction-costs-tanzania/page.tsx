      ...
      <main>
        <article className="max-w-4xl mx-auto px-4 py-20">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600">Ready-mix concrete prices in Dar es Salaam typically range from approximately 130,000 TZS per m³ for C10 to 400,000 TZS per m³ for C50, including 18% VAT. Volume discounts are available for larger orders.</p>
          </section>
