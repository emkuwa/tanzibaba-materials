      ...
      <main>
        ...
        <article className="py-12 px-4 bg-white">
          <div className="max-w-3xl mx-auto prose prose-gray prose-lg">
            ...
            <p>
              Tanzibaba uses advanced washed sand technology that removes silt and clay from the aggregate, producing cleaner concrete with superior bond strength. This is especially important for foundations where long-term durability is critical. Order <Link href="/services/ready-mix-concrete-dar-es-salaam" className="text-brand-600 font-semibold hover:underline">ready-mix concrete for your foundation →</Link>
            </p>
