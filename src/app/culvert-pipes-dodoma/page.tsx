...
export const metadata: Metadata = {
  title: 'Culvert Pipes Dodoma | Precast Concrete | Tanzibaba',
  description: 'Quality precast concrete culvert pipes for drainage and infrastructure projects across Dodoma. Reliable supply and project support.',
  keywords: ['culvert pipes Dodoma', 'precast concrete pipes Dodoma', 'drainage pipes Dodoma', 'infrastructure pipes Dodoma'],
  alternates: { canonical: `${siteUrl}/culvert-pipes-dodoma` },
  openGraph: {
    title: 'Culvert Pipes Dodoma | Tanzibaba',
    description: 'Quality precast concrete culvert pipes for drainage and infrastructure projects across Dodoma.',
