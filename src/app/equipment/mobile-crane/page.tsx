...
export const metadata: Metadata = {
  title: 'Mobile Crane Hire Tanzania | Rent Cranes for Construction | Tanzibaba',
  description: 'Hire mobile cranes in Tanzania for lifting heavy loads on construction and industrial sites. Short-term and long-term rental. Rent, buy or rent-to-own.',
  keywords: ['mobile crane hire Tanzania', 'crane rental Dar es Salaam', 'hire mobile crane', 'crane for construction', 'crane with operator'],
  alternates: { canonical: `${siteUrl}/equipment/mobile-crane` },
  openGraph: {
    title: 'Mobile Crane Hire Tanzania — Rent, Buy or Rent-to-Own',
    description: 'Hire mobile cranes in Tanzania for lifting heavy loads on construction and industrial sites. Short-term and long-term rental. Rent, buy or rent-to-own.',
    url: `${siteUrl}/equipment/mobile-crane`,
    siteName: 'Tanzibaba',
    type: 'website',
    locale: 'en_TZ',
  },
...
const applications = [
  { icon: Wrench, title: 'Lifting & Rigging', desc: 'Precision lifting and positioning of heavy equipment and structural components.' },
  { icon: Building2, title: 'Steel Structure Installation', desc: 'Erecting steel frames, trusses and beams for commercial and industrial buildings.' },
  { icon: Route, title: 'Concrete Panel Placement', desc: 'Safe handling and installation of precast concrete panels and tilt-up walls.' },
  { icon: Truck, title: 'Equipment Installation', desc: 'Hoisting and setting machinery, HVAC units and industrial equipment into position.' },
];

const industries = [
  { icon: Building2, title: 'Commercial Construction', desc: 'High-rise buildings, shopping centres and office complexes requiring heavy lifting.' },
  { icon: HardHat, title: 'Infrastructure', desc: 'Bridge construction, road projects and public works with demanding lift requirements.' },
  { icon: Route, title: 'Industrial Projects', desc: 'Factory installations, refinery maintenance and heavy industrial plant projects.' },
  { icon: Globe, title: 'Warehousing & Logistics', desc: 'Racking installation, mezzanine construction and warehouse equipment placement.' },
];

const benefits = [
  { icon: Wrench, title: 'Well-Maintained Fleet', desc: 'All mobile cranes serviced regularly and inspected before every hire.' },
  { icon: Users, title: 'Trained Operators', desc: 'Certified crane operators with extensive experience on diverse job sites.' },
  { icon: Clock, title: 'Flexible Hire Periods', desc: 'Daily, weekly and monthly rental options tailored to your project schedule.' },
  { icon: Truck, title: 'Nationwide Delivery', desc: 'Cranes delivered and set up on site by our logistics team across Tanzania.' },
];

const faqs = [
  { q: 'What crane lifting capacities are available?', a: 'We offer a range of mobile cranes from 10-tonne to 100-tonne capacity, suitable for everything from light equipment lifting to heavy structural steel erection.' },
  { q: 'Do you provide certified crane operators?', a: 'Yes, all our crane operators are fully certified and experienced in operating mobile cranes across various construction and industrial settings.' },
  { q: 'Can I rent cranes long-term?', a: 'Yes, we offer daily, weekly and monthly rental periods with discounted rates for long-term projects.' },
  { q: 'How is the crane delivered?', a: 'Cranes are delivered and set up on site by our experienced team, including all rigging equipment and safety checks.' },
  { q: 'What about crane maintenance?', a: 'We provide 24/7 breakdown support. If any issue arises, we repair on-site or replace the crane promptly at no additional cost.' },
];
      ...
      <main>
        ...
        <div className="bg-gray-50 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Mobile Cranes</span>
            </div>
          </div>
        </div>
        ...
        <section className="relative min-h-[60vh] flex items-center bg-gray-950 overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/equipment/mobile-crane-hire-tanzania.webp" alt="Mobile crane available for hire in Tanzania" fill className="object-cover" style={{ objectPosition: '50% 40%' }} priority fetchPriority="high" sizes="100vw" quality={85} />
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3">Mobile Crane Applications</h2>
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Versatile lifting solutions for the toughest construction and industrial tasks.</p>
            </div>
        ...
        <section className="py-16 md:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Mobile cranes for every sector — from commercial construction to industrial projects.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {industries.map(ind => (
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Reliable mobile cranes, flexible terms and nationwide support.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map(b => (
        ...
        <section className="py-16 md:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Our mobile crane fleet — well-maintained and ready for your project.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="aspect-[4/3] bg-gray-100 rounded-2xl overflow-hidden relative">
                <Image src="/images/equipment/mobile-crane-hire-tanzania.webp" alt="Mobile crane on construction site" fill className="object-cover" sizes="(max-width: 640px) 100vw, 33vw" />
              </div>
              <div className="aspect-[4/3] bg-gray-100 rounded-2xl overflow-hidden relative">
                <Image src="/images/equipment/mobile-crane-hire-tanzania.webp" alt="Mobile crane lifting" fill className="object-cover" sizes="(max-width: 640px) 100vw, 33vw" />
              </div>
              <div className="aspect-[4/3] bg-gray-100 rounded-2xl overflow-hidden relative">
                <Image src="/images/equipment/mobile-crane-hire-tanzania.webp" alt="Mobile crane with operator" fill className="object-cover" sizes="(max-width: 640px) 100vw, 33vw" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 text-sm md:text-base">Common questions about mobile crane hire with Tanzibaba.</p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold mb-4">Ready to Hire a Mobile Crane?</h2>
                <p className="text-gray-400 text-sm md:text-lg mb-8 max-w-2xl mx-auto">Get a quote within minutes. Our team will match you with the right crane for your project.</p>
