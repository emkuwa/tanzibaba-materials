...
export const metadata: Metadata = {
  ...
  description: 'Quality aggregates and gravel supply for construction projects across Zanzibar. Materials supplied through our established logistics network to support residential, commercial and infrastructure developments.',
  keywords: ['aggregates Zanzibar', 'gravel supplier Zanzibar', 'crushed stone Zanzibar', 'construction aggregates Zanzibar'],
  alternates: { canonical: `${siteUrl}/aggregates-supplier-zanzibar` },
  openGraph: {
    title: 'Aggregates Supplier Zanzibar | Tanzibaba',
    description: 'Quality aggregates and gravel supply for construction projects across Zanzibar.',
    url: `${siteUrl}/aggregates-supplier-zanzibar`,
    siteName: 'Tanzibaba',
    type: 'website',
    locale: 'en_TZ',
...
export default function AggregatesZanzibarPage() {
  return (
    <>
      <Navbar />
      <main>
        <section className="relative min-h-[60vh] flex items-center bg-gray-950 overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/new/aggregates.webp" alt="Aggregates supply in Zanzibar" fill className="object-cover" style={{ objectPosition: '50% 40%' }} priority fetchPriority="high" sizes="100vw" quality={85} />
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-36">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Quality aggregates and gravel supply for construction projects across Zanzibar. Materials supplied through our established logistics network to support residential, commercial and infrastructure developments.
              </p>
        ...
        <section className="py-14 px-4 bg-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3">Aggregates for Zanzibar Projects</h2>
              <p className="text-gray-500 max-w-xl mx-auto text-sm">Tanzibaba supplies quality aggregates and gravel to Zanzibar through our established logistics network, supporting residential, commercial and infrastructure developments.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                { title: 'Hotels & Resorts', desc: 'Quality aggregates for resort developments, beachfront hotels and hospitality projects across Zanzibar.' },
                { title: 'Residential Projects', desc: 'Reliable aggregate supply for residential developments, apartments and private homes in Stone Town and beyond.' },
                { title: 'Commercial Buildings', desc: 'Commercial aggregate supply for retail centers, office buildings and mixed-use developments in Zanzibar.' },
                { title: 'Infrastructure Projects', desc: 'Aggregates for roads, drainage, water infrastructure and public works projects across the islands.' },
              ].map((s, i) => (
