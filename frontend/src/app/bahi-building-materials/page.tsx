...
export const metadata: Metadata = {
  title: 'Building Materials Bahi — Zege, Kokoto & Blocks | Tanzibaba',
  description: 'Building materials supplier in Bahi, Dodoma. Ready mix concrete, aggregates, kokoto, blocks, paving blocks and culvert pipes.',
  keywords: ['building materials Bahi', 'zege Bahi', 'kokoto Bahi', 'concrete Bahi', 'blocks Bahi', 'vifaa vya ujenzi Bahi', 'msambazaji wa zege Bahi', 'aggregates Bahi'],
  alternates: { canonical: `${siteUrl}/bahi-building-materials` },
  openGraph: {
    title: 'Building Materials Bahi — Zege, Kokoto & Blocks | Tanzibaba',
    description: 'Building materials supplier in Bahi, Dodoma. Concrete, aggregates, blocks and pipes.',
    url: `${siteUrl}/bahi-building-materials`,
    siteName: 'Tanzibaba',
    type: 'website',
    locale: 'en_TZ',
...
export default function BahiBuildingMaterialsPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        <section className="relative min-h-[50vh] flex items-center bg-gray-950 overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/new/aggregates.webp" alt="Building materials supplier Bahi" fill className="object-cover" style={{ objectPosition: '50% 40%' }} priority fetchPriority="high" sizes="100vw" quality={85} />
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-36">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 bg-brand-600/20 border border-brand-500/30 text-brand-300 px-4 py-2 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
                <MapPin className="w-4 h-4" /> Bahi District — Dodoma
              </div>
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Complete building materials supplier in Bahi district, Dodoma. Ready mix concrete, aggregates, kokoto, blocks, paving blocks and culvert pipes for construction projects.
              </p>
        ...
        <section className="py-14 px-4 bg-white">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3">Building Materials Available in Bahi</h2>
              <p className="text-gray-500 max-w-xl mx-auto text-sm">We deliver the full range of construction materials to Bahi district.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                { title: 'Zege (Swahili)', desc: 'Zege bora kwa ujenzi Bahi', swahili: 'Zege bora', href: '/zege-dodoma', color: 'brand' },
              ].map((item, i) => (
        ...
        <section className="py-14 px-4 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3">Bahi Building Materials FAQs</h2>
            </div>
            <div className="space-y-4">
              {[
                { q: 'Do you deliver building materials to Bahi district?', a: 'Yes, we deliver all building materials to Bahi district including ready mix concrete, aggregates, blocks, paving blocks and culvert pipes.' },
                { q: 'How long does delivery take to Bahi?', a: 'Delivery to Bahi typically takes 2-4 hours from order confirmation. Same-day delivery available for orders placed before 2:00 PM.' },
                { q: 'What materials do you supply in Bahi?', a: 'We supply the complete range of building materials in Bahi including concrete, aggregates, kokoto, blocks, paving blocks and culvert pipes.' },
              ].map((faq, i) => (
        ...
        <section className="py-14 px-4 bg-white">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-4">Need Materials in Bahi?</h2>
            <p className="text-gray-500 max-w-lg mx-auto mb-8 text-sm">Contact us for building materials supply to Bahi district. Fast delivery, competitive prices!</p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'FAQPage',
        mainEntity: [
          { '@type': 'Question', name: 'Do you deliver building materials to Bahi district?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, we deliver all building materials to Bahi district including ready mix concrete, aggregates, blocks, paving blocks and culvert pipes.' } },
          { '@type': 'Question', name: 'How long does delivery take to Bahi?', acceptedAnswer: { '@type': 'Answer', text: 'Delivery to Bahi typically takes 2-4 hours from order confirmation. Same-day delivery available.' } },
        ]
      }) }} />
    </>
  );
