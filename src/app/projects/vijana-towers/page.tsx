    ...
    <>
      ...
      <main>
        ...
        <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden mb-8">
          <Image src="/images/new/commercial-building.webp" alt="Vijana Towers — premium concrete supply by Tanzibaba for this landmark commercial high-rise in Dar es Salaam" fill className="object-cover" sizes="(max-width: 768px) 100vw, 896px" priority />
        </div>
