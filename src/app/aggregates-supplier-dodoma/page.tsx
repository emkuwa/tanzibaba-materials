...
export const metadata: Metadata = {
  title: 'Aggregates Supplier Dodoma | Quality Materials | Tanzibaba',
  description: 'Quality aggregates and gravel supply for construction projects across Dodoma. Crushed stone, gravel and construction aggregates for government, commercial and infrastructure developments.',
  keywords: ['aggregates Dodoma', 'gravel supplier Dodoma', 'crushed stone Dodoma', 'construction aggregates Dodoma'],
  alternates: { canonical: `${siteUrl}/aggregates-supplier-dodoma` },
  openGraph: {
    title: 'Aggregates Supplier Dodoma | Tanzibaba',
    description: 'Quality aggregates and gravel supply for construction projects across Dodoma.',
