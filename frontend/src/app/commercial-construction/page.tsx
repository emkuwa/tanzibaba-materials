...
export const metadata: Metadata = {
  title: 'Commercial Construction — Office, Retail & Mixed-Use | Tanzibaba',
  description: 'Tanzibaba delivers commercial construction projects across Tanzania — office complexes, retail centers, hotels and mixed-use developments. Primary operations in Dar es Salaam, Zanzibar and Dodoma. Additional projects across Tanzania subject to requirements.',
  keywords: ['commercial construction Tanzania', 'office construction Dar es Salaam', 'retail construction', 'mixed-use development Tanzania', 'hotel construction Tanzania', 'commercial building contractor'],
  alternates: { canonical: `${siteUrl}/commercial-construction` },
  openGraph: {
    title: 'Commercial Construction — Office, Retail & Mixed-Use | Tanzibaba',
    ...
    url: `${siteUrl}/commercial-construction`,
    siteName: 'Tanzibaba',
    type: 'website',
    locale: 'en_TZ',
      ...
      <main>
        <section className="relative min-h-[70vh] flex items-center bg-gray-950 overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/new/commercial-building.webp" alt="Commercial construction projects by Tanzibaba in Dar es Salaam and Dodoma" fill className="object-cover" style={{ objectPosition: '50% 40%' }} priority fetchPriority="high" sizes="100vw" quality={85} />
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 md:py-40">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 bg-brand-600/20 border border-brand-500/30 text-brand-300 px-4 py-2 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
                <Building2 className="w-4 h-4" /> Commercial Construction
              </div>
              ...
              <p className="text-lg sm:text-xl text-gray-300 leading-relaxed mb-8 max-w-2xl">
                Delivering office complexes, retail centers, hotels and mixed-use developments across Tanzania. Primary operations in Dar es Salaam, Zanzibar and Dodoma, with additional projects undertaken in other regions subject to project requirements.
              </p>
        ...
        <section className="py-14 px-4 bg-gray-50">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Link href="/commercial-construction-dar-es-salaam" className="group bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-lg transition-all">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-gray-900 group-hover:text-brand-600 transition-colors">Dar es Salaam</h3>
                    <p className="text-sm text-gray-500 mt-1">Commercial construction across all districts.</p>
                  </div>
              ...
              <Link href="/commercial-construction-dodoma" className="group bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-lg transition-all">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-bold text-gray-900 group-hover:text-brand-600 transition-colors">Dodoma</h3>
                    <p className="text-sm text-gray-500 mt-1">Commercial construction in Tanzania's capital.</p>
                  </div>
                  <ArrowRight className="w-5 h-5 text-brand-600 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0" />
                </div>
              </Link>
