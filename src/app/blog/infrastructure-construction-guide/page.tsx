      ...
      <main>
        <article className="max-w-4xl mx-auto px-4 py-20">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600">Tanzibaba supplies all materials required for infrastructure construction, from <Link href="/services/ready-mix-concrete-dar-es-salaam" className="text-brand-600 font-semibold hover:underline">concrete</Link> and <Link href="/aggregates-supplier-zanzibar" className="text-brand-600 font-semibold hover:underline">aggregates</Link> to precast products and culvert pipes. Our Class 1 contractor capabilities ensure project delivery to specification.</p>
          </section>
