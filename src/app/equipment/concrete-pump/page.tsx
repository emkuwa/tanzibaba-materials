...
export const metadata: Metadata = {
  title: 'Concrete Pump Hire Tanzania | Rent Concrete Pumps | Tanzibaba',
  description: 'Hire concrete pumps in Tanzania for precise concrete placement at height and distance. Short-term and long-term rental with trained operators. Rent, buy or rent-to-own.',
  keywords: ['concrete pump hire Tanzania', 'concrete pump rental Dar es Salaam', 'concrete pumping services', 'boom pump hire', 'line pump hire'],
  alternates: { canonical: `${siteUrl}/equipment/concrete-pump` },
  openGraph: {
    title: 'Concrete Pump Hire Tanzania — Rent, Buy or Rent-to-Own',
    description: 'Hire concrete pumps in Tanzania for precise concrete placement. Flexible rental, purchase and rent-to-own options.',
    url: `${siteUrl}/equipment/concrete-pump`,
    siteName: 'Tanzibaba',
    type: 'website',
    locale: 'en_TZ',
  },
...
const applications = [
  { icon: Building2, title: 'High-Rise Construction', desc: 'Pumping concrete to upper floors of multi-storey buildings with precision and speed.' },
  { icon: Route, title: 'Bridge & Infrastructure', desc: 'Concrete placement for bridge decks, piers and abutments.' },
  { icon: Truck, title: 'Large Slab Pours', desc: 'Efficient concrete placement for large floor slabs and foundations.' },
  { icon: Wrench, title: 'Hard-to-Reach Areas', desc: 'Pumping concrete to confined or inaccessible locations.' },
];

const industries = [
  { icon: Building2, title: 'Commercial Construction', desc: 'Office towers, shopping centres and mixed-use developments.' },
  { icon: HardHat, title: 'Infrastructure', desc: 'Bridges, dams, roads and public works projects.' },
  { icon: Wrench, title: 'Industrial Projects', desc: 'Factories, warehouses and industrial facility construction.' },
  { icon: Globe, title: 'Residential Developments', desc: 'Multi-storey apartment blocks and large housing projects.' },
];

const benefits = [
  { icon: Wrench, title: 'Well-Maintained Fleet', desc: 'All concrete pumps serviced regularly and tested before every hire.' },
  { icon: Users, title: 'Trained Operators', desc: 'Experienced pump operators included with all hires for safe and efficient operation.' },
  { icon: Clock, title: 'Flexible Hire Periods', desc: 'Daily, weekly and monthly rental options tailored to your project schedule.' },
  { icon: Truck, title: 'Nationwide Delivery', desc: 'Equipment delivered to your site across Tanzania with full logistics support.' },
];

const faqs = [
  { q: 'What types of concrete pumps are available?', a: 'We offer boom pumps and line pumps to suit different project requirements. Boom pumps provide high reach and volume, while line pumps are ideal for smaller or confined placements.' },
  { q: 'Do you provide operators?', a: 'Yes, trained pump operators are included with all hires to ensure safe and efficient concrete placement.' },
  { q: 'What is the maximum pumping height?', a: 'Boom pumps can reach up to 40m depending on the model. Our team will help select the right pump for your project height requirements.' },
  { q: 'How do you ensure consistent concrete flow?', a: 'All equipment is maintained and tested before every hire. Our operators perform pre-pour checks to ensure consistent flow and prevent blockages.' },
  { q: 'What if the pump breaks down?', a: 'We provide 24/7 breakdown support. In the unlikely event of a fault, we repair on-site or arrange replacement equipment promptly at no additional cost.' },
];

export default function ConcretePumpPage() {
  return (
    <>
      <Navbar />
      <main>
        ...
        <div className="bg-gray-50 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Concrete Pumps</span>
            </div>
          </div>
        </div>
        ...
        <section className="relative min-h-[60vh] flex items-center bg-gray-950 overflow-hidden">
          <div className="absolute inset-0">
            <Image src="/images/equipment/concrete-pump-truck-tanzania.webp" alt="Concrete pump available for hire in Tanzania" fill className="object-cover" style={{ objectPosition: '50% 40%' }} priority fetchPriority="high" sizes="100vw" quality={85} />
          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
            <div className="max-w-2xl">
              ...
              <p className="text-lg sm:text-xl text-gray-300 leading-relaxed mb-8 max-w-lg">
                Reliable concrete pumps for precise placement at height and distance. Rent, buy or rent-to-own with trained operators.
              </p>
              <div className="flex flex-wrap gap-3">
                <a href="https://wa.me/255716002790?text=Hi%20Tanzibaba!%20I%20am%20interested%20in%20hiring%20a%20concrete%20pump.%20Please%20send%20me%20more%20information." target="_blank" className="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white font-semibold px-6 py-3.5 rounded-xl transition-all shadow-lg shadow-brand-600/30 text-sm">
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3">Concrete Pump Applications</h2>
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Precision concrete placement for any project — from high-rises to hard-to-reach areas.</p>
            </div>
        ...
        <section className="py-16 md:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Concrete pumping solutions for every sector.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {industries.map(ind => (
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Reliable pumps, skilled operators and nationwide support.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map(b => (
        ...
        <section className="py-16 md:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Our concrete pump fleet — well-maintained and ready for your project.</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="aspect-[4/3] bg-gray-100 rounded-2xl overflow-hidden relative">
                <Image src="/images/equipment/concrete-pump-truck-tanzania.webp" alt="Concrete pump on construction site" fill className="object-cover" sizes="(max-width: 640px) 100vw, 33vw" />
              </div>
              <div className="aspect-[4/3] bg-gray-100 rounded-2xl overflow-hidden relative">
                <Image src="/images/equipment/concrete-pump-truck-tanzania.webp" alt="Boom pump pouring concrete" fill className="object-cover" sizes="(max-width: 640px) 100vw, 33vw" />
              </div>
              <div className="aspect-[4/3] bg-gray-100 rounded-2xl overflow-hidden relative">
                <Image src="/images/equipment/concrete-pump-truck-tanzania.webp" alt="Concrete pump with operator" fill className="object-cover" sizes="(max-width: 640px) 100vw, 33vw" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 text-sm md:text-base">Common questions about concrete pump hire with Tanzibaba.</p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-br from-gray-900 to-gray-950 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold mb-4">Ready to Hire a Concrete Pump?</h2>
                <p className="text-gray-400 text-sm md:text-lg mb-8 max-w-2xl mx-auto">Get a quote within minutes. Our team will match you with the right concrete pump for your project.</p>
